...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/media/media/icons/apple-touch-icon-180x180.png') }}">
                    ...
                    <div class="row -small">
                        <div class="header__logo -small col-auto">
                                <span class="header-logo__inner">
                                    <a href="{{ route('home') }}">
                                    <img class="header-logo__image" src="{{ asset('assets/media/media/logo/logo.svg') }}" alt="Логотип Memorial book">
                                </span></a>
                        </div>
                            ...
                            <nav class="header-menu__container">
                                <ul class="header-menu__list">
                                    ...
                                    <li class="header-menu__item -secondary">
                                        <a class="header-menu__link" href="{{ route('family-tree') }}">Семейное древо</a>
                                    </li>
                                    <li class="header-menu__item -secondary">
                                ...
                                <div class="header__personal -small col">
                                    <div class="row -small">
                                        <div class="header-personal__item -small -auth col">
                                            <a class="header-personal__button btn btn-primary" href="#slideout-auth" role="button" data-slideout=""
                                               data-slideout-options="{&quot;type&quot;:&quot;auth&quot;}">Вход</a>
                                        </div>
                                        <div class="header-personal__item -small -register col">
                                            <a class="header-personal__button btn btn-outline-primary" href="#slideout-register" role="button"
                                               data-slideout="" data-slideout-options="{&quot;type&quot;:&quot;register&quot;}">Регистрация</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="footer__logo col-auto">
                                <span class="footer-logo__inner">
                                    <img class="footer-logo__image" src="{{ asset('assets/media/media/logo/logo-light.svg') }}" alt="Логотип Memorial book">
                                </span>
                        </div>
                                ...
                                <ul class="footer-menu__list">
                                    ...
                                    <li class="footer-menu__item">
                                        <a class="footer-menu__link" href="#slideout-people" data-slideout=""
                                           data-slideout-options="{&quot;type&quot;:&quot;people&quot;,&quot;position&quot;:&quot;top&quot;}">Поиск людей
                                        </a>
                                    </li>
                                    <li class="footer-menu__item">
                        ...
                        <div class="footer__policy col-auto">
                            <a class="footer-policy__link" href="javascript:void(0)">Политика обработки персональных данных</a>
                        </div>
                    </div>
                </div>
            </div>
