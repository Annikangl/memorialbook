...
@section('content')
    ...
    <section class="community">
        <div class="community-banner">
            <img src="{{ asset('storage/' . $community->banner) }}"
                 class="bg-img"
                 alt="banner"
                 title="banner"/>
        </div>
                        ...
                        @foreach($followers as $follower)
                            @if($follower->avatar)
                                <li class="followers__item">
                                    <img src="{{ asset('storage/' . $follower->avatar) }}" class="bg-img" style="border-radius: 50px"
                                         alt="" title=""/>
                                </li>
                            @endif
                        @endforeach
        ...
        <div class="community-memorials community-tab"></div>



        <div class="community-videos community-tab"></div>
    </section>
@endsection
