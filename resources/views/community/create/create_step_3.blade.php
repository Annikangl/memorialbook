<div class="steep hide">
    ...
    <div class="steep-wrap grid-col-2_3">
        ...
        <div class="user-total-info">
            <h3 class="user-total-info__name">Biker Сlub «Sons of Anarchy»</h3>
    ...
    <div class="steep-wrap">
        <span class="input-wrap__title">Подтверждающие документы:</span>
        <div class="input-photo">
            ...
            <label class="input-photo-load">
                ...
                <span class="input-photo-load__text">Добавить документ</span>
                <input type="file" class="load-files" name="" accept=".pdf" multiple/>
            </label>
        </div>
