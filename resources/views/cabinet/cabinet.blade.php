                ...
                <div class="edit-profile-wrap grid-col-2">
                    <div class="input-wrap">
                        ...
                        <div class="input-form">
                            <input type="text" class="input-text" name="first_name" title=""/>
                        </div>
                    </div>
                    <div class="input-wrap">
                        <span class="input-wrap__title">Отчество:</span>
                        <div class="input-form">
                            <input type="text" class="input-text" name="patronymic" title=""/>
                        </div>
                    </div>
                    <div class="input-wrap">
                        <span class="input-wrap__title">Фамилия:</span>
                        <div class="input-form">
                            <input type="text" class="input-text" name="last_name" title=""/>
                        </div>
                    </div>
                    <div class="input-wrap">
                        <span class="input-wrap__title">Email:</span>
                        <div class="input-form">
                            <input type="email" class="input-text" name="email" value="{{ $user->email }}" title=""/>
                        </div>
                    </div>
                    <div class="input-wrap">
                        <span class="input-wrap__title">Телефон:</span>
                        <div class="input-form">
                            <input type="email" class="input-text" name="phone" value="{{ $user->phone }}" title=""/>
                        </div>
                    </div>
                    <button type="button" class="button-save btn blue-btn">Сохранить</button>
                </div>
