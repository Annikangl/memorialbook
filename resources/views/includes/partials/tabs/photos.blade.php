<div class="community-photos community-tab">
    <ul class="community-photos-list">
        ...
        <li class="community-photos-list__item">
            <a href="{{ asset('storage/uploads/community/img-1.jpg') }}" class="community-photos-list__link gallery"
               data-fancybox="img-community">
                <img src="{{ asset('storage/uploads/community/img-1.jpg') }}" class="bg-img" alt="" title=""/>
            </a>
        </li>
        @endforeach
    </ul>
