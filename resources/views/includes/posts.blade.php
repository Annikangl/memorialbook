    ...
    <article class="community-article">
        <div class="article-author">
            ...
            <div class="article-author-name-wrap">
                <h6 class="article-author__name">{{ $post->author->full_name }}</h6>
        ...
        <div class="swiper article-slider">
            <ul class="article-slider-list swiper-wrapper">
                <li class="article-slider-list__item swiper-slide">
                    <a href="img/community/poster.png" class="article-slider-list__link gallery"
                       data-fancybox="img-slider">
                        <img src="img/community/poster.png" alt="" title=""/>
                    </a>
                </li>
                <li class="article-slider-list__item swiper-slide">
                    <a href="img/community/poster.png" class="article-slider-list__link gallery"
...
@endforeach
    ...
    <article class="community-article">
        ...
        <img src="img/community/img-1.jpg" class="article-img" alt="" title=""/>
    ...
    <article class="community-article">
        ...
        <img src="img/community/img-2.png" class="article-img" alt="" title=""/>
        ...
        <p class="article-text">Get tickets here:
            <a href="http://www.laemmle.com/theaters/25/2015-11-06#get-tickets">link</a></p>
