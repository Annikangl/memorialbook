...
{{--                    </li>--}}
            ...
            <form class="add-cemetery-wrap" id="add-cemetery" action="{{ route('profile.family.store') }}" method="post">
                @csrf
                <div class="steep">
                    <div class="steep-wrap">
                        ...
                        <div class="profiles-search">
                            ...
                            <input type="search" class="profiles-search__input" name="profiles-search"
