                ...
                <div class="member-avatar">
                    <div class="member-avatar__wrap">
                        <img
                            ...
                            class="bg-img"
                            alt="{{ $human->getFirstMediaUrl('avatars', 'thumb') }}"
...
{{--                    @endif--}}
            ...
            <div class="member-info-biography">
                <p class="member-info__death">
                    Причина смерти: <span class="reason">{{ $human->death_reason }}</span>
                </p>
                <p id="member-info__desc" class="member-info__desc member-info__desc--hide">
                    {{ $human->description }}
                </p>
                <button id="toggleButton" class="member-info__more">
                    Показать полностью
                </button>
                <ul class="interests">
                    @foreach($human->hobbies as $hobby)
                        <li class="interests__item">{{ $hobby }}</li>
                    @endforeach
