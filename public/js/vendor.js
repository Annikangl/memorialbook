            ...
            e = n.nmd(e),
                function(t, n) {
                    ...
                    "object" === r(e) && "object" === r(e.exports) ? e.exports = t.document ? n(t, !0) : function(e) {
                            ...
                            g.extend = g.fn.extend = function() {
                                ...
                                for ("boolean" == typeof s && (c = s,
                                    ...
                                    if (null != (e = arguments[l]))
                                        for (t in e)
                                            i = e[t],
                                            "__proto__" !== t && s !== i && (c && i && (g.isPlainObject(i) || (o = Array.isArray(i))) ? (n = s[t],
                                                a = o && !Array.isArray(n) ? [] : o || g.isPlainObject(n) ? n : {},
                                                o = !1,
                                                s[t] = g.extend(c, a, i)) : void 0 !== i && (s[t] = i));
                                return s
                            }
                            ,
                            g.extend({
                        ...
                        var G = function(e) {
                            var t, n, r, i, o, a, s, l, u, c, d, T, f, p, S, b, h, A, P, M = "sizzle" + 1 * new Date, m = e.document, g = 0, v = 0, G = le(), y = le(), C = le(), B = le(), E = function(e, t) {
                                return e === t && (d = !0),
                                    0
                            }, H = {}.hasOwnProperty, x = [], I = x.pop, D = x.push, w = x.push, N = x.slice, O = function(e, t) {
                                for (var n = 0, r = e.length; n < r; n++)
                                    if (e[n] === t)
                                        return n;
                                return -1
                            }, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", V = "(?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", k = "\\[[\\x20\\t\\r\\n\\f]*(" + V + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + V + "))|)" + R + "*\\]", F = ":(" + V + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + k + ")*)|.*)\\)|)", X = new RegExp(R + "+","g"), W = new RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"), K = new RegExp("^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*"), U = new RegExp("^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*"), j = new RegExp(R + "|>"), _ = new RegExp(F), Q = new RegExp("^" + V + "$"), q = {
                                ID: new RegExp("^#(" + V + ")"),
                                CLASS: new RegExp("^\\.(" + V + ")"),
                                TAG: new RegExp("^(" + V + "|[*])"),
                                ATTR: new RegExp("^" + k),
                            ...
                            }, z = /HTML$/i, $ = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
                            ...
                            try {
                                w.apply(x = N.call(m.childNodes), m.childNodes),
                                        ...
                                        if (o = d[1]) {
                                            if (9 === m) {
                                                ...
                                                if (u.id === o)
                                                    return r.push(u),
                                                        r
                                            } else if (A && (u = A.getElementById(o)) && P(t, u) && u.id === o)
                                                return r.push(u),
                                                    r
                                        } else {
                                            if (d[2])
                                                return w.apply(r, t.getElementsByTagName(e)),
                                                    r;
                                            if ((o = d[3]) && n.getElementsByClassName && t.getElementsByClassName)
                                                return w.apply(r, t.getElementsByClassName(o)),
                                                    r
                                        }
                                    if (n.qsa && !B[e + " "] && (!b || !b.test(e)) && (1 !== m || "object" !== t.nodeName.toLowerCase())) {
                                        if (h = e,
                                            A = t,
                                        1 === m && (j.test(e) || U.test(e))) {
                                            for ((A = ee.test(e) && he(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(re, ie) : t.setAttribute("id", c = M)),
                                                     s = (p = a(e)).length; s--; )
                                                p[s] = (c ? "#" + c : ":scope") + " " + Pe(p[s]);
                                            h = p.join(",")
                                        }
                                        try {
                                            return w.apply(r, A.querySelectorAll(h)),
                                                r
                                        } catch (t) {
                                            B(e, !0)
                                        } finally {
                            ...
                            for (t in n = se.support = {},
                                ...
                                T = se.setDocument = function(e) {
                                    ...
                                    return a != f && 9 === a.nodeType && a.documentElement ? (p = (f = a).documentElement,
                                        S = !o(f),
                                    m != f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)),
                                    ...
                                    (n.qsa = J.test(f.querySelectorAll)) && (ce((function(e) {
                                            ...
                                            e.querySelectorAll("[msallowcapture^='']").length && b.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")"),
                                            e.querySelectorAll("[selected]").length || b.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|" + L + ")"),
                                            e.querySelectorAll("[id~=" + M + "-]").length || b.push("~="),
                                                (t = f.createElement("input")).setAttribute("name", ""),
                                                e.appendChild(t),
                                            e.querySelectorAll("[name='']").length || b.push("\\[[\\x20\\t\\r\\n\\f]*name[\\x20\\t\\r\\n\\f]*=[\\x20\\t\\r\\n\\f]*(?:''|\"\")"),
                                            e.querySelectorAll(":checked").length || b.push(":checked"),
                                            e.querySelectorAll("a#" + M + "+*").length || b.push(".#.+[+~]"),
                                        ...
                                        ce((function(e) {
                                                ...
                                                e.querySelectorAll("[name=d]").length && b.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?="),
                                    ...
                                    (n.matchesSelector = J.test(A = p.matches || p.webkitMatchesSelector || p.mozMatchesSelector || p.oMatchesSelector || p.msMatchesSelector)) && ce((function(e) {
                                        ...
                                        P = t || J.test(p.contains) ? function(e, t) {
                                        ...
                                        E = t ? function(e, t) {
                                            ...
                                            : function(e, t) {
                                                ...
                                                if (!i || !o)
                                                    return e == f ? -1 : t == f ? 1 : i ? -1 : o ? 1 : c ? O(c, e) - O(c, t) : 0;
                                                if (i === o)
                                                    return Te(e, t);
                                ...
                                se.matchesSelector = function(e, t) {
                                    if (T(e),
                                    n.matchesSelector && S && !B[t + " "] && (!h || !h.test(t)) && (!b || !b.test(t)))
                                        try {
                                            var r = A.call(e, t);
                                ...
                                se.contains = function(e, t) {
                                    return (e.ownerDocument || e) != f && T(e),
                                        P(e, t)
                                }
                                ,
                                ...
                                (r = se.selectors = {
                                    ...
                                    preFilter: {
                                        ...
                                        PSEUDO: function(e) {
                                            var t, n = !e[6] && e[2];
                                            return q.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && _.test(n) && (t = a(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                                                e[2] = n.slice(0, t)),
                                                e.slice(0, 3))
                                        }
                                    },
                                    filter: {
                                        ...
                                        ATTR: function(e, t, n) {
                                            return function(r) {
                                                var i = se.attr(r, e);
                                                return null == i ? "!=" === t : !t || (i += "",
                                                    "=" === t ? i === n : "!=" === t ? i !== n : "^=" === t ? n && 0 === i.indexOf(n) : "*=" === t ? n && i.indexOf(n) > -1 : "$=" === t ? n && i.slice(-n.length) === n : "~=" === t ? (" " + i.replace(X, " ") + " ").indexOf(n) > -1 : "|=" === t && (i === n || i.slice(0, n.length + 1) === n + "-"))
                                            }
                                        },
                                        CHILD: function(e, t, n, r, i) {
                                            ...
                                            return 1 === r && 0 === i ? function(e) {
                                                ...
                                                : function(t, n, l) {
                                                    var u, c, d, T, f, p, S = o !== a ? "nextSibling" : "previousSibling", b = t.parentNode, h = s && t.nodeName.toLowerCase(), A = !l && !s, P = !1;
                                                    if (b) {
                                                        if (o) {
                                                            for (; S; ) {
                                                                for (T = t; T = T[S]; )
                                                                    if (s ? T.nodeName.toLowerCase() === h : 1 === T.nodeType)
                                                                        return !1;
                                                                p = S = "only" === e && !p && "nextSibling"
                                                            }
                                                            return !0
                                                        }
                                                        if (p = [a ? b.firstChild : b.lastChild],
                                                        a && A) {
                                                            for (P = (f = (u = (c = (d = (T = b)[M] || (T[M] = {}))[T.uniqueID] || (d[T.uniqueID] = {}))[e] || [])[0] === g && u[1]) && u[2],
                                                                     T = f && b.childNodes[f]; T = ++f && T && T[S] || (P = f = 0) || p.pop(); )
                                                                if (1 === T.nodeType && ++P && T === t) {
                                                                    c[e] = [g, f, P];
                                                                    break
                                                                }
                                                        } else if (A && (P = f = (u = (c = (d = (T = t)[M] || (T[M] = {}))[T.uniqueID] || (d[T.uniqueID] = {}))[e] || [])[0] === g && u[1]),
                                                        !1 === P)
                                                            for (; (T = ++f && T && T[S] || (P = f = 0) || p.pop()) && ((s ? T.nodeName.toLowerCase() !== h : 1 !== T.nodeType) || !++P || (A && ((c = (d = T[M] || (T[M] = {}))[T.uniqueID] || (d[T.uniqueID] = {}))[e] = [g, P]),
                                                            T !== t)); )
                                                                ;
                                        ...
                                        PSEUDO: function(e, t) {
                                            ...
                                            return i[M] ? i(t) : i.length > 1 ? (n = [e, e, "", t],
                                        ...
                                        lang: ue((function(e) {
                                                return Q.test(e || "") || se.error("unsupported lang: " + e),
                                                    ...
                                                    function(t) {
                                                        var n;
                                                        do {
                                                            if (n = S ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang"))
                                ...
                                return t.first ? function(t, n, i) {
                                    ...
                                    : function(t, n, l) {
                                        ...
                                        if (l) {
                                            ...
                                            for (; t = t[r]; )
                                                if (1 === t.nodeType || a)
                                                    if (c = (d = t[M] || (t[M] = {}))[t.uniqueID] || (d[t.uniqueID] = {}),
                                                    i && i === t.nodeName.toLowerCase())
                                                        t = t[r] || t;
                                                    else {
                                                        if ((u = c[o]) && u[0] === g && u[1] === s)
                                                            return T[2] = u[2];
                                                        if (c[o] = T,
                                                            T[2] = e(t, n, l))
                                                            return !0
                                    ...
                                    ue((function(o, a, s, l) {
                                            var u, c, d, T = [], f = [], p = a.length, S = o || function(e, t, n) {
                                                for (var r = 0, i = t.length; r < i; r++)
                                                    se(e, t[r], n);
                                                return n
                                            }(t || "*", s.nodeType ? [s] : s, []), b = !e || !o && t ? S : ge(S, T, e, s, l), h = n ? i || (o ? e : p || r) ? [] : a : b;
                                            if (n && n(b, h, s, l),
                                                r)
                                                for (u = ge(h, f),
                                                         r(u, [], s, l),
                                            ...
                                            if (o) {
                                                if (i || e) {
                                                    ...
                                                    for (c = h.length; c--; )
                                                        (d = h[c]) && (u = i ? O(o, d) : T[c]) > -1 && (o[u] = !(a[u] = d))
                                                }
                                            } else
                                                h = ge(h === a ? h.splice(p, h.length) : h),
                                                    i ? i(null, a, h, l) : w.apply(a, h)
                                        }
                                    ))
                            }
                            function Ge(e) {
                                    ...
                                    if (n = r.relative[e[l].type])
                                        ...
                                        if ((n = r.filter[e[l].type].apply(null, e[l].matches))[M]) {
                                            for (i = ++l; i < o && !r.relative[e[i].type]; i++)
                                                ;
                                            return ve(l > 1 && me(T), l > 1 && Pe(e.slice(0, l - 1).concat({
                                                value: " " === e[l - 2].type ? "*" : ""
                                            })).replace(W, "$1"), n, l < i && Ge(e.slice(l, i)), i < o && Ge(e = e.slice(i)), i < o && Pe(e))
                                        }
                                        T.push(n)
                                    }
                                return me(T)
                            }
                            return Ae.prototype = r.filters = r.pseudos,
                                r.setFilters = new Ae,
                                a = se.tokenize = function(e, t) {
                                    ...
                                    for (s = e,
                                             l = [],
                                             u = r.preFilter; s; ) {
                                        for (a in n && !(i = K.exec(s)) || (i && (s = s.slice(i[0].length) || s),
                                            l.push(o = [])),
                                            n = !1,
                                ...
                                s = se.compile = function(e, t) {
                                    ...
                                    if (!s) {
                                        for (t || (t = a(e)),
                                                 n = t.length; n--; )
                                            (s = Ge(t[n]))[M] ? i.push(s) : o.push(s);
                                        (s = C(e, function(e, t) {
                                            var n = t.length > 0
                                                , i = e.length > 0
                                                , o = function(o, a, s, l, c) {
                                                var d, p, b, h = 0, A = "0", P = o && [], M = [], m = u, v = o || i && r.find.TAG("*", c), G = g += null == m ? 1 : Math.random() || .1, y = v.length;
                                                for (c && (u = a == f || a || c); A !== y && null != (d = v[A]); A++) {
                                                    if (i && d) {
                                                        for (p = 0,
                                                             a || d.ownerDocument == f || (T(d),
                                                                 s = !S); b = e[p++]; )
                                                            if (b(d, a || f, s)) {
                                                                l.push(d);
                                                                break
                                                ...
                                                n && A !== h) {
                                                    ...
                                                    if (o) {
                                                        if (h > 0)
                                                            for (; A--; )
                                                                P[A] || M[A] || (M[A] = I.call(l));
                                                        M = ge(M)
                                                    }
                                                    w.apply(l, M),
                                                    c && !o && M.length > 0 && h + t.length > 1 && se.uniqueSort(l)
                                                }
                                                return c && (g = G,
                                                    u = m),
                                                    P
                                ...
                                l = se.select = function(e, t, n, i) {
                                    ...
                                    1 === f.length) {
                                        ...
                                        for (o = q.needsContext.test(e) ? 0 : l.length; o-- && (u = l[o],
                                            !r.relative[c = u.type]); )
                                            if ((d = r.find[c]) && (i = d(u.matches[0].replace(te, ne), ee.test(l[0].type) && he(t.parentNode) || t))) {
                                                if (l.splice(o, 1),
                                                    !(e = i.length && Pe(l)))
                                                    return w.apply(n, i),
                                                        n;
                                    ...
                                    return (T || s(e, f))(i, t, !S, n, !t || ee.test(e) && he(t.parentNode) || t),
                                        n
                                }
                                ,
                                n.sortStable = M.split("").sort(E).join("") === M,
                        ...
                        g.find = G,
                            (g.expr = G.selectors)[":"] = g.expr.pseudos,
                            g.uniqueSort = g.unique = G.uniqueSort,
                            g.text = G.getText,
                            g.isXMLDoc = G.isXML,
                            g.contains = G.contains,
                            g.escapeSelector = G.escape;
                                ...
                                "string" == typeof e) {
                                    ...
                                    if (r[1]) {
                                        if (t = t instanceof g ? t[0] : t,
                                            g.merge(this, g.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : h, !0)),
                                        H.test(r[1]) && g.isPlainObject(t))
                                            for (r in t)
                                                S(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                                        return this
                                    }
                                    return (i = h.getElementById(r[2])) && (this[0] = i,
                                        this.length = 1),
                                        this
                                }
                                return e.nodeType ? (this[0] = e,
                                    this.length = 1,
                                    this) : S(e) ? void 0 !== n.ready ? n.ready(e) : e(g) : g.makeArray(e, this)
                            }
                        ).prototype = g.fn,
                            I = g(h);
                            ...
                            g.each({
                                ...
                                contents: function(e) {
                                    ...
                                    g.fn[e] = function(n, r) {
                                        ...
                                        this.length > 1 && (N[e] || g.uniqueSort(i),
                                        w.test(e) && i.reverse()),
                                            this.pushStack(i)
                                    }
                                }
                        ...
                        g.Callbacks = function(e) {
                            ...
                            g.extend({
                                        ...
                                        then: function(t, i, o) {
                                            ...
                                            function s(t, n, i, o) {
                                                return function() {
                                                    var l = this
                                                        ...
                                                        , c = function() {
                                                            ...
                                                            if (!(t < a)) {
                                                                ...
                                                                c = e && ("object" === r(e) || "function" == typeof e) && e.then,
                                                                    S(c) ? o ? c.call(e, s(a, n, R, o), s(a, n, V, o)) : (a++,
                                                                        c.call(e, s(a, n, R, o), s(a, n, V, o), s(a, n, R, n.notifyWith))) : (i !== R && (l = void 0,
                                                                        u = [e]),
                                                                        (o || n.resolveWith)(l, u))
                                                            }
                                                        }
                                                        , d = o ? c : function() {
                                                            try {
                                                                ...
                                                                g.Deferred.exceptionHook && g.Deferred.exceptionHook(e, d.stackTrace),
                                                                t + 1 >= a && (i !== V && (l = void 0,
                                                                    u = [e]),
                                                                    n.rejectWith(l, u))
                                                            }
                                                    ...
                                                    ;
                                                    t ? d() : (g.Deferred.getStackHook && (d.stackTrace = g.Deferred.getStackHook()),
                                                        e.setTimeout(d))
                                                }
                                            }
                                            return g.Deferred((function(e) {
                                                    n[0][3].add(s(0, e, S(o) ? o : R, e.notifyWith)),
                                                        n[1][3].add(s(0, e, S(t) ? t : R)),
                                                        n[2][3].add(s(0, e, S(i) ? i : V))
                                                }
                                            )).promise()
                                        },
                                        promise: function(e) {
                                ...
                                when: function(e) {
                                    ...
                                    if (t <= 1 && (k(e, a.done(s(n)).resolve, a.reject, !t),
                                    "pending" === a.state() || S(i[n] && i[n].then)))
                                        return a.then();
                                    for (; n--; )
                                        k(i[n], s(n), a.reject);
                                    return a.promise()
                        ...
                        var X = g.Deferred();
                        function W() {
                            h.removeEventListener("DOMContentLoaded", W),
                        ...
                        g.fn.ready = function(e) {
                            ...
                            g.extend({
                                ...
                                ready: function(e) {
                                    ...
                                    !0 !== e && --g.readyWait > 0 || X.resolveWith(h, [g]))
                                }
                            }),
                            g.ready.then = X.then,
                            "complete" === h.readyState || "loading" !== h.readyState && !h.documentElement.doScroll ? e.setTimeout(g.ready) : (h.addEventListener("DOMContentLoaded", W),
                            ...
                            g.fn.extend({
                                data: function(e, t) {
                                    ...
                                    if (void 0 === e) {
                                        ...
                                        1 === a.nodeType && !$.get(a, "hasDataAttrs"))) {
                                            for (n = s.length; n--; )
                                    ...
                                    return "object" === r(e) ? this.each((function() {
                                            ...
                                            var n;
                                            if (a && void 0 === t)
                                                return void 0 !== (n = Y.get(a, e)) || void 0 !== (n = ee(a, e)) ? n : void 0;
                                            this.each((function() {
                                                    Y.set(this, e, t)
                                                }
                                            ))
                            ...
                            g.extend({
                                queue: function(e, t, n) {
                                    ...
                                    if (e)
                                        return t = (t || "fx") + "queue",
                                            r = $.get(e, t),
                                        n && (!r || Array.isArray(n) ? r = $.access(e, t, g.makeArray(n)) : r.push(n)),
                                        r || []
                                },
                                dequeue: function(e, t) {
                                    var n = g.queue(e, t = t || "fx")
                                        , r = n.length
                                        , i = n.shift()
                                        , o = g._queueHooks(e, t);
                            ...
                            g.fn.extend({
                                ...
                                promise: function(e, t) {
                                    ...
                                    for ("string" != typeof e && (t = e,
                                        e = void 0),
                                             e = e || "fx"; a--; )
                                        (n = $.get(o[a], e + "queueHooks")) && n.empty && (r++,
                                            n.empty.add(s));
                                    return s(),
                                        i.promise(t)
                                }
                        ...
                        function ce(e, t) {
                            for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
                                (r = e[o]).style && (n = r.style.display,
                                    t ? ("none" === n && (i[o] = $.get(r, "display") || null,
                                    i[o] || (r.style.display = "")),
                                    "" === r.style.display && se(r) && (i[o] = ue(r))) : "none" !== n && (i[o] = "none",
                                        $.set(r, "display", n)));
                            for (o = 0; o < a; o++)
                        ...
                        de = h.createDocumentFragment().appendChild(h.createElement("div")),
                            (Te = h.createElement("input")).setAttribute("type", "radio"),
                        ...
                        be.tbody = be.tfoot = be.colgroup = be.caption = be.thead,
                            be.th = be.td,
                        p.option || (be.optgroup = be.option = [1, "<select multiple='multiple'>", "</select>"]);
                        var Pe = /<|&#?\w+;/;
                        function Me(e, t, n, r, i) {
                            for (var o, a, s, l, u, c, d = t.createDocumentFragment(), T = [], f = 0, p = e.length; f < p; f++)
                                if ((o = e[f]) || 0 === o)
                                    if ("object" === M(o))
                                        g.merge(T, o.nodeType ? [o] : o);
                                    else if (Pe.test(o)) {
                                        for (a = a || d.appendChild(t.createElement("div")),
                                                 s = (pe.exec(o) || ["", ""])[1].toLowerCase(),
                                                 l = be[s] || be._default,
                                                 a.innerHTML = l[1] + g.htmlPrefilter(o) + l[2],
                                                 c = l[0]; c--; )
                                            a = a.lastChild;
                                        g.merge(T, a.childNodes),
                                            (a = d.firstChild).textContent = ""
                                    } else
                                        T.push(t.createTextNode(o));
                            for (d.textContent = "",
                                     f = 0; o = T[f++]; )
                                if (r && g.inArray(o, r) > -1)
                                    i && i.push(o);
                                else if (u = oe(o),
                                ...
                                g.event.add(e, t, {
                                    ...
                                    handler: function(e) {
                                        ...
                                        if (1 & e.isTrigger && this[t]) {
                                            if (a.length)
                                                (g.event.special[t] || {}).delegateType && e.stopPropagation();
                                            else if (a = o.call(arguments),
                                                $.set(this, t, a),
                                                r = n(this, t),
                                                this[t](),
                                                a !== (i = $.get(this, t)) || r ? $.set(this, t, !1) : i = {},
                                            a !== i)
                                            ...
                                            a.length && ($.set(this, t, {
                                                value: g.event.trigger(g.extend(a[0], g.Event.prototype), a.slice(1), this)
                                            }),
                        ...
                        g.event = {
                            ...
                            add: function(e, t, n, r, i) {
                                ...
                                if (q(e))
                                    for (n.handler && (n = (o = n).handler,
                                        i = o.selector),
                                         i && g.find.matchesSelector(ie, i),
                                         n.guid || (n.guid = g.guid++),
                                         (l = b.events) || (l = b.events = Object.create(null)),
                                        ...
                                        (T = l[f]) || ((T = l[f] = []).delegateCount = 0,
                                        d.setup && !1 !== d.setup.call(e, r, p, a) || e.addEventListener && e.addEventListener(f, a)),
                                        d.add && (d.add.call(e, c),
                                        c.handler.guid || (c.handler.guid = n.guid)),
                                            i ? T.splice(T.delegateCount++, 0, c) : T.push(c),
                                            g.event.global[f] = !0)
                            },
                            remove: function(e, t, n, r, i) {
                                ...
                                if (b && (l = b.events)) {
                                    for (u = (t = (t || "").match(L) || [""]).length; u--; )
                                        if (f = S = (s = me.exec(t[u]) || [])[1],
                                            p = (s[2] || "").split(".").sort(),
                                            f) {
                                            for (d = g.event.special[f] || {},
                                                     T = l[f = (r ? d.delegateType : d.bindType) || f] || [],
                                                     s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                                                     a = o = T.length; o--; )
                                                c = T[o],
                                                !i && S !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (T.splice(o, 1),
                                                c.selector && T.delegateCount--,
                                                d.remove && d.remove.call(e, c));
                                            a && !T.length && (d.teardown && !1 !== d.teardown.call(e, p, b.handle) || g.removeEvent(e, f, b.handle),
                                                delete l[f])
                                        } else
                                            for (f in l)
                                                g.event.remove(e, f + t[u], n, r, !0);
                                    g.isEmptyObject(l) && $.remove(e, "handle events")
                                }
                            },
                            dispatch: function(e) {
                                var t, n, r, i, o, a, s = new Array(arguments.length), l = g.event.fix(e), u = ($.get(this, "events") || Object.create(null))[l.type] || [], c = g.event.special[l.type] || {};
                                for (s[0] = l,
                                         t = 1; t < arguments.length; t++)
                                    s[t] = arguments[t];
                                if (l.delegateTarget = this,
                                !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                                    for (a = g.event.handlers.call(this, l, u),
                                        ...
                                        for (l.currentTarget = i.elem,
                                            ...
                                            l.rnamespace && !1 !== o.namespace && !l.rnamespace.test(o.namespace) || (l.handleObj = o,
                                                l.data = o.data,
                                            void 0 !== (r = ((g.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (l.result = r) && (l.preventDefault(),
                                                l.stopPropagation()));
                                    ...
                                    for (; u !== this; u = u.parentNode || this)
                                        if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                                            for (o = [],
                                                     a = {},
                                                     n = 0; n < l; n++)
                                                void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? g(i, this).index(u) > -1 : g.find(i, this, null, [u]).length),
                                                a[i] && o.push(r);
                                            o.length && s.push({
                                                elem: u,
                                                handlers: o
                            ...
                            special: {
                                ...
                                click: {
                                    setup: function(e) {
                                        var t = this || e;
                                        return fe.test(t.type) && t.click && E(t, "input") && Ce(t, "click", ge),
                                            !1
                                    },
                                    trigger: function(e) {
                                        var t = this || e;
                                        return fe.test(t.type) && t.click && E(t, "input") && Ce(t, "click"),
                                            !0
                                    },
                                    _default: function(e) {
                                        var t = e.target;
                            ...
                            (g.Event = function(e, t) {
                                    ...
                                    e && e.type ? (this.originalEvent = e,
                                        this.type = e.type,
                                        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? ge : ve,
                        ...
                        function we(e, t) {
                            var n, r, i, o, a, s;
                            if (1 === t.nodeType) {
                                if ($.hasData(e) && (s = $.get(e).events))
                                    for (i in $.remove(t, "handle events"),
                                        s)
                                        for (n = 0,
                                                 r = s[i].length; n < r; n++)
                                            g.event.add(t, i, s[i][n]);
                        ...
                        function Oe(e, t, n, r) {
                            ...
                            if (h || T > 1 && "string" == typeof b && !p.checkClone && Ee.test(b))
                                return e.each((function(i) {
                                        var o = e.eq(i);
                                        h && (t[0] = b.call(this, i, o.html())),
                                            Oe(o, t, n, r)
                                    }
                                ));
                            if (T && (o = (i = Me(t, e[0].ownerDocument, !1, e, r)).firstChild,
                            1 === i.childNodes.length && (i = o),
                            o || r)) {
                                for (l = (s = g.map(he(i, "script"), Ie)).length; d < T; d++)
                                    u = i,
                                    d !== f && (u = g.clone(u, !0, !0),
                                    l && g.merge(s, he(u, "script"))),
                                        n.call(e[d], u, d);
                                if (l)
                                    for (c = s[s.length - 1].ownerDocument,
                                             ...
                                             d = 0; d < l; d++)
                                        u = s[d],
                                        Se.test(u.type || "") && !$.access(u, "globalEval") && g.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? g._evalUrl && !u.noModule && g._evalUrl(u.src, {
                                            nonce: u.nonce || u.getAttribute("nonce")
                                        }, c) : P(u.textContent.replace(He, ""), u, c))
                            }
                            return e
                        }
                        function Le(e, t, n) {
                            for (var r, i = t ? g.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
                                n || 1 !== r.nodeType || g.cleanData(he(r)),
                                r.parentNode && (n && oe(r) && Ae(he(r, "script")),
                        ...
                        g.extend({
                            ...
                            clone: function(e, t, n) {
                                ...
                                if (t)
                                    if (n)
                                        ...
                                        we(e, s);
                                return (a = he(s, "script")).length > 0 && Ae(a, !l && he(e, "script")),
                                    s
                            },
                            ...
                            g.fn.extend({
                                ...
                                empty: function() {
                                    for (var e, t = 0; null != (e = this[t]); t++)
                                        1 === e.nodeType && (g.cleanData(he(e, !1)),
                                            e.textContent = "");
                                    return this
                                },
                                clone: function(e, t) {
                                ...
                                html: function(e) {
                                    return K(this, (function(e) {
                                            ...
                                            if ("string" == typeof e && !Be.test(e) && !be[(pe.exec(e) || ["", ""])[1].toLowerCase()]) {
                                                ...
                                                try {
                                                    for (; n < r; n++)
                                                        1 === (t = this[n] || {}).nodeType && (g.cleanData(he(t, !1)),
                                                            t.innerHTML = e);
                                                    t = 0
                                                } catch (e) {}
                                            }
                                ...
                                replaceWith: function() {
                                    ...
                                    return Oe(this, arguments, (function(t) {
                                            ...
                                            g.inArray(this, e) < 0 && (g.cleanData(he(this)),
                            ...
                            g.each({
                                ...
                                replaceAll: "replaceWith"
                                    ...
                                    g.fn[e] = function(e) {
                                        for (var n, r = [], i = g(e), o = i.length - 1, a = 0; a <= o; a++)
                        ...
                        function Xe(e, t, n) {
                            ...
                            return (n = n || Ve(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = g.style(e, t)),
                            !p.pixelBoxStyles() && Re.test(a) && Fe.test(t) && (r = s.width,
                                i = s.minWidth,
                                o = s.maxWidth,
                        ...
                        function Je(e, t, n, r, i, o) {
                            ...
                            if (n === (r ? "border" : "content"))
                                return 0;
                            for (; a < 4; a += 2)
                                "margin" === n && (l += g.css(e, n + re[a], !0, i)),
                                    r ? ("content" === n && (l -= g.css(e, "padding" + re[a], !0, i)),
                                    "margin" !== n && (l -= g.css(e, "border" + re[a] + "Width", !0, i))) : (l += g.css(e, "padding" + re[a], !0, i),
                                        "padding" !== n ? l += g.css(e, "border" + re[a] + "Width", !0, i) : s += g.css(e, "border" + re[a] + "Width", !0, i));
                            return !r && o >= 0 && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - l - s - .5)) || 0),
                                l
                        }
                        function Ze(e, t, n) {
                            var r = Ve(e)
                                , i = (!p.boxSizingReliable() || n) && "border-box" === g.css(e, "boxSizing", !1, r)
                                , o = i
                                , a = Xe(e, t, r)
                            ...
                            return (!p.boxSizingReliable() && i || !p.reliableTrDimensions() && E(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === g.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === g.css(e, "boxSizing", !1, r),
                            (o = s in e) && (a = e[s])),
                        ...
                        g.extend({
                                ...
                                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                                    ...
                                    "string" === (a = r(n)) && (o = ne.exec(n)) && o[1] && (n = function(e, t, n, r) {
                                        var i, o, a = 20, s = r ? function() {
                                            ...
                                            , l = s(), u = n && n[3] || (g.cssNumber[t] ? "" : "px"), c = e.nodeType && (g.cssNumber[t] || "px" !== u && +l) && ne.exec(g.css(e, t));
                                        if (c && c[3] !== u) {
                                            for (l /= 2,
                                                     u = u || c[3],
                                                     c = +l || 1; a--; )
                                        ...
                                        a = "number"),
                                    null != n && n == n && ("number" !== a || u || (n += o && o[3] || (g.cssNumber[l] ? "" : "px")),
                                    p.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"),
                                    s && "set"in s && void 0 === (n = s.set(e, n, i)) || (u ? c.setProperty(t, n) : c[t] = n))
                                }
                            },
                            css: function(e, t, n, r) {
                                var i, o, a, s = Q(t);
                                return qe.test(t) || (t = _e(s)),
                            ...
                            g.each(["height", "width"], (function(e, t) {
                                    g.cssHooks[t] = {
                                        get: function(e, n, r) {
                                            if (n)
                                                return !Qe.test(g.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, r) : ke(e, ze, (function() {
                                                        return Ze(e, t, r)
                                                    }
                                                ))
                                        },
                                        set: function(e, n, r) {
                                            var i, o = Ve(e), a = !p.scrollboxSize() && "absolute" === o.position, s = (a || r) && "border-box" === g.css(e, "boxSizing", !1, o), l = r ? Je(e, t, r, s, o) : 0;
                                            return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - .5)),
                                            l && (i = ne.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                                                n = g.css(e, t)),
                                                Ye(0, n, l)
                                        }
                                    }
                            ...
                            g.cssHooks.marginLeft = We(p.reliableMarginLeft, (function(e, t) {
                                    if (t)
                                        return (parseFloat(Xe(e, "marginLeft")) || e.getBoundingClientRect().left - ke(e, {
                                            marginLeft: 0
                                        }, (function() {
                        ...
                        g.fn.extend({
                            ...
                            g.extend({
                                attr: function(e, t, n) {
                                    ...
                                    if (3 !== o && 8 !== o && 2 !== o)
                                        return void 0 === e.getAttribute ? g.prop(e, t, n) : (1 === o && g.isXMLDoc(e) || (i = g.attrHooks[t.toLowerCase()] || (g.expr.match.bool.test(t) ? et : void 0)),
                                            void 0 !== n ? null === n ? void g.removeAttr(e, t) : i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
                                                n) : i && "get"in i && null !== (r = i.get(e, t)) ? r : null == (r = g.find.attr(e, t)) ? void 0 : r)
                                },
                                attrHooks: {
                                    type: {
                                        set: function(e, t) {
                                ...
                                toggleClass: function(e, t) {
                                    ...
                                    return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : S(e) ? this.each((function(n) {
                                            ...
                                            if (i)
                                                ...
                                                void 0 !== e && "boolean" !== n || ((t = ot(this)) && $.set(this, "__className__", t),
                                    ...
                                    select: {
                                        ...
                                        set: function(e, t) {
                                            for (var n, r, i = e.options, o = g.makeArray(t), a = i.length; a--; )
                                                ((r = i[a]).selected = g.inArray(g.valHooks.option.get(r), o) > -1) && (n = !0);
                        ...
                        g.extend(g.event, {
                            trigger: function(t, n, i, o) {
                                var a, s, l, u, c, T, f, p, A = [i || h], P = d.call(t, "type") ? t.type : t, M = d.call(t, "namespace") ? t.namespace.split(".") : [];
                                if (s = p = l = i = i || h,
                                3 !== i.nodeType && 8 !== i.nodeType && !lt.test(P + g.event.triggered) && (P.indexOf(".") > -1 && (M = P.split("."),
                                    P = M.shift(),
                                    M.sort()),
                                    c = P.indexOf(":") < 0 && "on" + P,
                                    (t = t[g.expando] ? t : new g.Event(P,"object" === r(t) && t)).isTrigger = o ? 2 : 3,
                                    t.namespace = M.join("."),
                                ...
                                o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                                    if (!o && !f.noBubble && !b(i)) {
                                        for (u = f.delegateType || P,
                                             lt.test(u + P) || (s = s.parentNode); s; s = s.parentNode)
                                            A.push(s),
                                                l = s;
                                        l === (i.ownerDocument || h) && A.push(l.defaultView || l.parentWindow || e)
                                    }
                                    for (a = 0; (s = A[a++]) && !t.isPropagationStopped(); )
                                        p = s,
                                            t.type = a > 1 ? u : f.bindType || P,
                                        (T = ($.get(s, "events") || Object.create(null))[t.type] && $.get(s, "handle")) && T.apply(s, n),
                                        (T = c && s[c]) && T.apply && q(s) && (t.result = T.apply(s, n),
                                        !1 === t.result && t.preventDefault());
                                    return t.type = P,
                                    o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(A.pop(), n) || !q(i) || c && S(i[P]) && !b(i) && ((l = i[c]) && (i[c] = null),
                                        g.event.triggered = P,
                                    t.isPropagationStopped() && p.addEventListener(P, ut),
                                        i[P](),
                                    t.isPropagationStopped() && p.removeEventListener(P, ut),
                            ...
                            g.fn.extend({
                                ...
                                triggerHandler: function(e, t) {
                                    var n = this[0];
                                    if (n)
                                        return g.event.trigger(e, t, n, !0)
                                }
                            }),
                        p.focusin || g.each({
                            focus: "focusin",
                            blur: "focusout"
                                ...
                                g.event.special[t] = {
                                    ...
                                    teardown: function() {
                                        var r = this.ownerDocument || this.document || this
                                            , i = $.access(r, t) - 1;
                                        i ? $.access(r, t, i) : (r.removeEventListener(e, n, !0),
                                            $.remove(r, t))
                                    }
                                }
                            }
                            ...
                            g.parseXML = function(t) {
                                ...
                                n && !r || g.error("Invalid XML: " + (r ? g.map(r.childNodes, (function(e) {
                                        return e.textContent
                                    }
                                )).join("\n") : t)),
                                    n
                        ...
                        g.param = function(e, t) {
                            ...
                            g.fn.extend({
                                wrapAll: function(e) {
                                    var t;
                                    return this[0] && (S(e) && (e = e.call(this[0])),
                            ...
                            ,
                            p.createHTMLDocument = ((ct = h.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
                            2 === ct.childNodes.length),
                            g.parseHTML = function(e, t, n) {
                                return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
                                    t = !1),
                                t || (p.createHTMLDocument ? ((r = (t = h.implementation.createHTMLDocument("")).createElement("base")).href = h.location.href,
                                    t.head.appendChild(r)) : t = h),
                                    o = !n && [],
                                    (i = H.exec(e)) ? [t.createElement(i[1])] : (i = Me([e], t, o),
                                ...
                                position: function() {
                                    if (this[0]) {
                                        ...
                                        if ("fixed" === g.css(r, "position"))
                                            ...
                                            for (t = this.offset(),
                                                     n = r.ownerDocument,
                                                     e = r.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === g.css(e, "position"); )
                                                e = e.parentNode;
                                            e && e !== r && 1 === e.nodeType && ((i = g(e).offset()).top += g.css(e, "borderTopWidth", !0),
                                                i.left += g.css(e, "borderLeftWidth", !0))
                                        }
                                        return {
                                            ...
                                            g.fn[r] = function(i, o) {
                                                ...
                                                return K(this, (function(t, n, i) {
                                                        ...
                                                        return b(t) ? 0 === r.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement,
                                                            Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? g.css(t, n, s) : g.style(t, n, i, s)
                                                    }
                                                ), t, a ? i : void 0, a)
                                            }
                                        }
                ...
                e((function() {
                        ...
                        return n.FALLBACK_PHONE = "UnknownPhone",
                                    ...
                                    if (r.call(c.props, t)) {
                                        for (i = c.props[t],
                                             e(i) || (i = [i]),
                                                 l = i.length,
                                                 s = 0; s < l; ++s)
                                            (u = (o = i[s]).indexOf("[VER]")) >= 0 && (o = o.substring(0, u) + "([\\w._\\+]+)" + o.substring(u + 5)),
                                                i[s] = new RegExp(o,"i");
                                        c.props[t] = i
                                    }
                                a(c.oss),
                            ...
                            n.findMatches = function(e, t) {
                                var n = [];
                                for (var i in e)
                                    r.call(e, i) && e[i].test(t) && n.push(i);
                                return n
                            }
                            ,
                                ...
                                if (e.mobile === t) {
                                    ...
                                    if (a = n.findMatch(n.mobileDetectRules.tablets, r))
                                        return e.mobile = e.tablet = a,
                                            void (e.phone = null);
                                    if (o = n.findMatch(n.mobileDetectRules.phones, r))
                                        return e.mobile = e.phone = o,
                                            void (e.tablet = null);
                                    n.isMobileFallback(r) ? (l = s.isPhoneSized(i)) === t ? (e.mobile = n.FALLBACK_MOBILE,
                                        e.tablet = e.phone = null) : l ? (e.mobile = e.phone = n.FALLBACK_PHONE,
            ...
            e = n.nmd(e),
                function() {
                    ...
                    var i = {
                        ...
                        , o = i["undefined" == typeof window ? "undefined" : r(window)] && window || this
                        , a = i[r(t)] && t
                    ...
                    var m = function e(t) {
                        var n = o
                            , i = t && "object" == r(t) && "String" != h(t);
                        i && (n = t,
                            t = null);
                        var a = n.navigator || {}
                            , s = a.userAgent || "";
                        t || (t = s);
                        var l, u, d, T, p, m = i ? !!a.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(f.toString()), g = "Object", v = i ? g : "ScriptBridgingProxyObject", G = i ? g : "Environment", y = i && n.java ? "JavaPackage" : h(n.java), C = i ? g : "RuntimeObject", B = /\bJava/.test(y) && n.java, E = B && h(n.environment) == G, H = B ? "a" : "α", x = B ? "b" : "β", I = n.document || {}, D = n.operamini || n.opera, w = c.test(w = i && D ? D["[[Class]]"] : h(D)) ? w : D = null, N = t, O = [], L = null, R = t == s, V = R && D && "function" == typeof D.version && D.version(), k = P([{
                            label: "EdgeHTML",
                            pattern: "Edge"
                        }, "Trident", {
                            label: "WebKit",
                            ...
                            return P(e, (function(e, n) {
                                    ...
                                    return !e && (e = RegExp("\\b" + r + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(t)) && (e = function(e, t, n) {
                                        ...
                                        t && n && (e = e.replace(RegExp(t, "i"), n)),
                                            S(e.replace(/ ce$/i, " CE").replace(/\bhpw/i, "web").replace(/\bMacintosh\b/, "Mac OS").replace(/_PowerPC\b/i, " OS").replace(/\b(OS X) [^ \d]+/i, "$1").replace(/\bMac (OS X)\b/, "$1").replace(/\/(\d)/, " $1").replace(/_/g, ".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i, "").replace(/\bx86\.64\b/gi, "x86_64").replace(/\b(Windows Phone) OS\b/, "$1").replace(/\b(Chrome OS \w+) [\d.]+\b/, "$1").split(" on ")[0])
                                    }(e, r, n.label || n)),
                                        e
                                }
                            ))
                        ...
                        function U(e) {
                            return P(e, (function(e, n) {
                                    ...
                                    return !e && (e = RegExp("\\b" + r + " *\\d+[.\\w_]*", "i").exec(t) || RegExp("\\b" + r + " *\\w+-[\\w]*", "i").exec(t) || RegExp("\\b" + r + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(t)) && ((e = String(n.label && !RegExp(r, "i").test(n.label) ? n.label : e).split("/"))[1] && !/[\d.]+/.test(e[0]) && (e[0] += " " + e[1]),
                                        n = n.label || n,
                                        e = S(e[0].replace(RegExp(r, "i"), n).replace(RegExp("; *(?:" + n + "[_-])?", "i"), " ").replace(RegExp("(" + n + ")[-_.]?(\\w)", "i"), "$1 $2"))),
                                        e
                                }
                            ))
                        }
                        ...
                        if (k && (k = [k]),
                        /\bAndroid\b/.test(K) && !X && (l = /\bAndroid[^;]*;(.*?)(?:Build|\) AppleWebKit)\b/i.exec(t)) && (X = M(l[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") || null),
                            W && !X ? X = U([W]) : W && X && (X = X.replace(RegExp("^(" + A(W) + ")[-_.\\s]", "i"), W + " ").replace(RegExp("^(" + A(W) + ")[-_.]?(\\w)", "i"), W + " $2")),
                        (l = /\bGoogle TV\b/.exec(X)) && (X = l[0]),
                        /\bSimulator\b/i.test(t) && (X = (X ? X + " " : "") + "Simulator"),
                        "Opera Mini" == F && /\bOPiOS\b/.test(t) && O.push("running in Turbo/Uncompressed mode"),
                            "IE" == F && /\blike iPhone OS\b/.test(t) ? (W = (l = e(t.replace(/like iPhone OS/, ""))).manufacturer,
                                X = l.product) : /^iP/.test(X) ? (F || (F = "Safari"),
                                K = "iOS" + ((l = / OS ([\d_]+)/i.exec(t)) ? " " + l[1].replace(/_/g, ".") : "")) : "Konqueror" == F && /^Linux\b/i.test(K) ? K = "Kubuntu" : W && "Google" != W && (/Chrome/.test(F) && !/\bMobile Safari\b/i.test(t) || /\bVita\b/.test(X)) || /\bAndroid\b/.test(K) && /^Chrome/.test(F) && /\bVersion\//i.test(t) ? (F = "Android Browser",
                                K = /\bAndroid\b/.test(K) ? K : "Android") : "Silk" == F ? (/\bMobi/i.test(t) || (K = "Android",
                                O.unshift("desktop mode")),
                            /Accelerated *= *true/i.test(t) && O.unshift("accelerated")) : "UC Browser" == F && /\bUCWEB\b/.test(t) ? O.push("speed mode") : "PaleMoon" == F && (l = /\bFirefox\/([\d.]+)\b/.exec(t)) ? O.push("identifying as Firefox " + l[1]) : "Firefox" == F && (l = /\b(Mobile|Tablet|TV)\b/i.exec(t)) ? (K || (K = "Firefox OS"),
                            X || (X = l[1])) : !F || (l = !/\bMinefield\b/i.test(t) && /\b(?:Firefox|Safari)\b/.exec(F)) ? (F && !X && /[\/,]|^[^(]+?\)/.test(t.slice(t.indexOf(l + "/") + 8)) && (F = null),
                            (l = X || W || K) && (X || W || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(K)) && (F = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(K) ? K : l) + " Browser")) : "Electron" == F && (l = (/\bChrome\/([\d.]+)\b/.exec(t) || 0)[1]) && O.push("Chromium " + l),
                        V || (V = j(["(?:Cloud9|CriOS|CrMo|Edge|Edg|EdgA|EdgiOS|FxiOS|HeadlessChrome|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$)|UCBrowser|YaBrowser)", "Version", A(F), "(?:Firefox|Minefield|NetFront)"])),
                        (l = ("iCab" == k && parseFloat(V) > 3 ? "WebKit" : /\bOpera\b/.test(F) && (/\bOPR\b/.test(t) ? "Blink" : "Presto")) || /\b(?:Midori|Nook|Safari)\b/i.test(t) && !/^(?:Trident|EdgeHTML)$/.test(k) && "WebKit" || !k && /\bMSIE\b/i.test(t) && ("Mac OS" == K ? "Tasman" : "Trident") || "WebKit" == k && /\bPlayStation\b(?! Vita\b)/i.test(F) && "NetFront") && (k = [l]),
                            "IE" == F && (l = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(t) || 0)[1]) ? (F += " Mobile",
                                K = "Windows Phone " + (/\+$/.test(l) ? l : l + ".x"),
                                O.unshift("desktop mode")) : /\bWPDesktop\b/i.test(t) ? (F = "IE Mobile",
                                K = "Windows Phone 8.x",
                                O.unshift("desktop mode"),
                            V || (V = (/\brv:([\d.]+)/.exec(t) || 0)[1])) : "IE" != F && "Trident" == k && (l = /\brv:([\d.]+)/.exec(t)) && (F && O.push("identifying as " + F + (V ? " " + V : "")),
                                F = "IE",
                                V = l[1]),
                            R) {
                            if (T = "global",
                                p = null != (d = n) ? r(d[T]) : "number",
                            /^(?:boolean|number|string|undefined)$/.test(p) || "object" == p && !d[T])
                                h(l = n.runtime) == v ? (F = "Adobe AIR",
                                    K = l.flash.system.Capabilities.os) : h(l = n.phantom) == C ? (F = "PhantomJS",
                                    V = (l = l.version || null) && l.major + "." + l.minor + "." + l.patch) : "number" == typeof I.documentMode && (l = /\bTrident\/(\d+)/i.exec(t)) ? (V = [V, I.documentMode],
                                (l = +l[1] + 4) != V[1] && (O.push("IE " + V[1] + " mode"),
                                k && (k[1] = ""),
                                    V[1] = l),
                                    V = "IE" == F ? String(V[1].toFixed(1)) : V[0]) : "number" == typeof I.documentMode && /^(?:Chrome|Firefox)\b/.test(F) && (O.push("masking as " + F + " " + V),
                                    F = "IE",
                                    V = "11.0",
                                    k = ["Trident"],
                                    K = "Windows");
                            else if (B && (N = (l = B.lang.System).getProperty("os.arch"),
                                K = K || l.getProperty("os.name") + " " + l.getProperty("os.version")),
                                E) {
                                try {
                                    V = n.require("ringo/engine").version.join("."),
                                        F = "RingoJS"
                                } catch (e) {
                                    (l = n.system) && l.global.system == n.system && (F = "Narwhal",
                                    K || (K = l[0].os || null))
                                }
                                F || (F = "Rhino")
                            } else
                                "object" == r(n.process) && !n.process.browser && (l = n.process) && ("object" == r(l.versions) && ("string" == typeof l.versions.electron ? (O.push("Node " + l.versions.node),
                                    F = "Electron",
                                    V = l.versions.electron) : "string" == typeof l.versions.nw && (O.push("Chromium " + V, "Node " + l.versions.node),
                                    F = "NW.js",
                                    V = l.versions.nw)),
                                F || (F = "Node.js",
                                    N = l.arch,
                                    K = l.platform,
                                    V = (V = /[\d.]+/.exec(l.version)) ? V[0] : null));
                            K = K && S(K)
                        }
                        if (V && (l = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(V) || /(?:alpha|beta)(?: ?\d)?/i.exec(t + ";" + (R && a.appMinorVersion)) || /\bMinefield\b/i.test(t) && "a") && (L = /b/i.test(l) ? "beta" : "alpha",
                            V = V.replace(RegExp(l + "\\+?$"), "") + ("beta" == L ? x : H) + (/\d+\+?/.exec(l) || "")),
                        "Fennec" == F || "Firefox" == F && /\b(?:Android|Firefox OS|KaiOS)\b/.test(K))
                            F = "Firefox Mobile";
                        else if ("Maxthon" == F && V)
                            V = V.replace(/\.[\d.]+/, ".x");
                        else if (/\bXbox\b/i.test(X))
                            "Xbox 360" == X && (K = null),
                            "Xbox 360" == X && /\bIEMobile\b/.test(t) && O.unshift("mobile mode");
                        else if (!/^(?:Chrome|IE|Opera)$/.test(F) && (!F || X || /Browser|Mobi/.test(F)) || "Windows CE" != K && !/Mobi/i.test(t))
                            if ("IE" == F && R)
                                try {
                                ...
                                (/\bBlackBerry\b/.test(X) || /\bBB10\b/.test(t)) && (l = (RegExp(X.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(t) || 0)[1] || V) ? (K = ((l = [l, /BB10/.test(t)])[1] ? (X = null,
                                    W = "BlackBerry") : "Device Software") + " " + l[0],
                                    V = null) : this != b && "Wii" != X && (R && D || /Opera/.test(F) && /\b(?:MSIE|Firefox)\b/i.test(t) || "Firefox" == F && /\bOS X (?:\d+\.){2,}/.test(K) || "IE" == F && (K && !/^Win/.test(K) && V > 5.5 || /\bWindows XP\b/.test(K) && V > 8 || 8 == V && !/\bTrident\b/.test(t))) && !c.test(l = e.call(b, t.replace(c, "") + ";")) && l.name && (l = "ing as " + l.name + ((l = l.version) ? " " + l : ""),
                                    c.test(F) ? (/\bIE\b/.test(l) && "Mac OS" == K && (K = null),
                                        l = "identify" + l) : (l = "mask" + l,
                                        F = w ? S(w.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera",
                                    /\bIE\b/.test(l) && (K = null),
                                    R || (V = null)),
                                    k = ["Presto"],
                                    O.push(l));
                        ...
                        (l = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) && (l = [parseFloat(l.replace(/\.(\d)$/, ".0$1")), l],
                            "Safari" == F && "+" == l[1].slice(-1) ? (F = "WebKit Nightly",
                                L = "alpha",
                                V = l[1].slice(0, -1)) : V != l[1] && V != (l[2] = (/\bSafari\/([\d.]+\+?)/i.exec(t) || 0)[1]) || (V = null),
                            l[1] = (/\b(?:Headless)?Chrome\/([\d.]+)/i.exec(t) || 0)[1],
                        537.36 == l[0] && 537.36 == l[2] && parseFloat(l[1]) >= 28 && "WebKit" == k && (k = ["Blink"]),
                            R && (m || l[1]) ? (k && (k[1] = "like Chrome"),
                                l = l[1] || ((l = l[0]) < 530 ? 1 : l < 532 ? 2 : l < 532.05 ? 3 : l < 533 ? 4 : l < 534.03 ? 5 : l < 534.07 ? 6 : l < 534.1 ? 7 : l < 534.13 ? 8 : l < 534.16 ? 9 : l < 534.24 ? 10 : l < 534.3 ? 11 : l < 535.01 ? 12 : l < 535.02 ? "13+" : l < 535.07 ? 15 : l < 535.11 ? 16 : l < 535.19 ? 17 : l < 536.05 ? 18 : l < 536.1 ? 19 : l < 537.01 ? 20 : l < 537.11 ? "21+" : l < 537.13 ? 23 : l < 537.18 ? 24 : l < 537.24 ? 25 : l < 537.36 ? 26 : "Blink" != k ? "27" : "28")) : (k && (k[1] = "like Safari"),
                                l = (l = l[0]) < 400 ? 1 : l < 500 ? 2 : l < 526 ? 3 : l < 533 ? 4 : l < 534 ? "4+" : l < 535 ? 5 : l < 537 ? 6 : l < 538 ? 7 : l < 601 ? 8 : l < 602 ? 9 : l < 604 ? 10 : l < 606 ? 11 : l < 608 ? 12 : "12"),
                        k && (k[1] += " " + (l += "number" == typeof l ? ".x" : /[.+]/.test(l) ? "" : "+")),
                            "Safari" == F && (!V || parseInt(V) > 45) ? V = l : "Chrome" == F && /\bHeadlessChrome/i.test(t) && O.unshift("headless")),
                            "Opera" == F && (l = /\bzbov|zvav$/.exec(K)) ? (F += " ",
                                O.unshift("desktop mode"),
                                "zvav" == l ? (F += "Mini",
                                    V = null) : F += "Mobile",
                                K = K.replace(RegExp(" *" + l + "$"), "")) : "Safari" == F && /\bChrome\b/.exec(k && k[1]) ? (O.unshift("desktop mode"),
                                F = "Chrome Mobile",
                                V = null,
                                /\bOS X\b/.test(K) ? (W = "Apple",
                                    K = "iOS 4.3+") : K = null) : /\bSRWare Iron\b/.test(F) && !V && (V = j("Chrome")),
                        V && 0 == V.indexOf(l = /[\d.]+$/.exec(K)) && t.indexOf("/" + l + "-") > -1 && (K = M(K.replace(l, ""))),
                        K && -1 != K.indexOf(F) && !RegExp(F + " OS").test(K) && (K = K.replace(RegExp(" *" + A(F) + " *"), "")),
                        k && !/\b(?:Avant|Nook)\b/.test(F) && (/Browser|Lunascape|Maxthon/.test(F) || "Safari" != F && /^iOS/.test(K) && /\bSafari\b/.test(k[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|SRWare Iron|Vivaldi|Web)/.test(F) && k[1]) && (l = k[k.length - 1]) && O.push(l),
                        O.length && (O = ["(" + O.join("; ") + ")"]),
                        W && X && X.indexOf(W) < 0 && O.push("on " + W),
                        X && O.push((/^on /.test(O[O.length - 1]) ? "" : "on ") + X),
                        K && (l = / ([\d.+]+)$/.exec(K),
                            u = l && "/" == K.charAt(K.length - l[0].length - 1),
                            K = {
                                architecture: 32,
                            ...
                            (l = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(N)) && !/\bi686\b/i.test(N) ? (K && (K.architecture = 64,
                                K.family = K.family.replace(RegExp(" *" + l), "")),
                            F && (/\bWOW64\b/i.test(t) || R && /\w(?:86|32)$/.test(a.cpuClass || a.platform) && !/\bWin64; x64\b/i.test(t)) && O.unshift("32-bit")) : K && /^OS X/.test(K.family) && "Chrome" == F && parseFloat(V) >= 39 && (K.architecture = 64),
                        t || (t = null);
                        var _ = {};
                        return _.description = t,
                            ...
                            ,
                        _.version && O.unshift(V),
                        _.name && O.unshift(F),
                        K && F && (K != String(K).split(" ")[0] || K != F.split(" ")[0] && !X) && O.push(X ? "(" + K + ")" : "on " + K),
                        O.length && (_.description = O.join(" ")),
                            _
                    }();
                    "function" == typeof define && "object" == r(define.amd) && define.amd ? (o.platform = m,
                        define((function() {
                                return m
                            }
